    ...
    <section className="home">
      <div className="hero">
        <div className="leftSide">
          ...
          <p>
          Welcome to our Student Grade Management system! Our platform is designed to streamline the process of managing student grades efficiently and effectively. With our user-friendly interface, educators can easily input, track, and analyze student grades to particular courses available, while students and parents can access their performance data in real-time.
          </p>
